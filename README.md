...
Здесь мы отошли от стандартных способов сделать многозадачность.
...
6. Ассинхронные порты - ну... Единственный способ общение.
...
Очень сложный механизм, но 699 строк вы прочитаете с удовольстием.
...
* **LIST / DICT [n]** — Сборка сложных структур данных из последних `n` элементов стека.
...
В третьих - копируйте все файлы из src в контроллер. Не саму папку.

Так же, можете почитать rMachIPC() из файла src/ipc.py.
